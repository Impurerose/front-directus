...
console.log('🚀 Generando HTML de Requisitos - Sección 1 (DEV MODE)...\n');

// SECCIÓN 1: Header + Hero + ImageText Principal + Accordion Documentos (DEV)
...
console.log('✅ Sección 1 (DEV) guardada en a365/requisitos-section1.txt');
console.log('🔧 Quoter CSS: localhost:5057 (core_tailwind) y localhost:5007 (quoter)');
