...
<div class="bg-white w-full py-9 2xl:py-16 pt-12 pb-12 2xl:pb-20 px-4">
  <div class="flex flex-col 2xl:flex-row justify-center 2xl:gap-32 items-center 2xl:px-20 max-w-[834px] 2xl:max-w-[1600px] mx-auto">
    <div class="_h-[360px] w-full max-w-[390px] 2xl:max-w-[486px] shrink-0 relative">
      <img alt="Viajar a ${destino}" class="_absolute _inset-0 w-full h-full object-cover rounded-lg" src="https://placehold.co/486x360">
    </div>
    <div class="flex flex-col 2xl:gap-10 w-full max-w-[390px] md:max-w-[548px] 2xl:max-w-[486px] shrink-0">
      <h2 class="2xl:text-5xl leading-[56px] font-semibold text-[#0059ba] whitespace-pre-wrap text-3xl pt-8 pb-4">¿Qué necesito para viajar a ${destino}?</h2>
...
<div class="bg-white w-full py-9 2xl:py-16 pt-12 pb-12 2xl:pb-20 px-4">
  <div class="flex flex-col 2xl:flex-row-reverse justify-center 2xl:gap-32 items-center 2xl:px-20 max-w-[834px] 2xl:max-w-[1600px] mx-auto">
    <div class="_h-[360px] w-full max-w-[390px] 2xl:max-w-[486px] shrink-0 relative">
      <img alt="Seguro de viaje" class="_absolute _inset-0 w-full h-full object-cover rounded-lg" src="https://placehold.co/256x256/0ea5e9/ffffff">
    </div>
    <div class="flex flex-col 2xl:gap-10 w-full max-w-[390px] md:max-w-[548px] 2xl:max-w-[486px] shrink-0">
      <h2 class="2xl:text-4xl leading-[40px] font-semibold text-[#0059ba] whitespace-pre-wrap text-3xl pt-8 pb-4">¿Es obligatorio el seguro de viaje para ${destino}?</h2>
...
<div class="bg-white w-full py-9 2xl:py-16 pt-12 pb-12 2xl:pb-20 px-4">
  <div class="flex flex-col 2xl:flex-row justify-center 2xl:gap-32 items-center 2xl:px-20 max-w-[834px] 2xl:max-w-[1600px] mx-auto">
    <div class="_h-[360px] w-full max-w-[390px] 2xl:max-w-[486px] shrink-0 relative">
      <img alt="Visa para viajar" class="_absolute _inset-0 w-full h-full object-cover rounded-lg" src="https://placehold.co/256x256/0ea5e9/ffffff">
    </div>
    <div class="flex flex-col 2xl:gap-10 w-full max-w-[390px] md:max-w-[548px] 2xl:max-w-[486px] shrink-0">
      <h2 class="2xl:text-4xl leading-[40px] font-semibold text-[#0059ba] whitespace-pre-wrap text-3xl pt-8 pb-4">¿Necesitas Visa para ingresar a ${destino}?</h2>
...
<div class="bg-white w-full py-9 2xl:py-16 pt-12 pb-12 2xl:pb-20 px-4">
  <div class="flex flex-col 2xl:flex-row-reverse justify-center 2xl:gap-32 items-center 2xl:px-20 max-w-[834px] 2xl:max-w-[1600px] mx-auto">
    <div class="_h-[360px] w-full max-w-[390px] 2xl:max-w-[486px] shrink-0 relative">
      <img alt="Vacunas obligatorias" class="_absolute _inset-0 w-full h-full object-cover rounded-lg" src="https://placehold.co/256x256/0ea5e9/ffffff">
    </div>
    <div class="flex flex-col 2xl:gap-10 w-full max-w-[390px] md:max-w-[548px] 2xl:max-w-[486px] shrink-0">
      <h2 class="2xl:text-4xl leading-[40px] font-semibold text-[#0059ba] whitespace-pre-wrap text-3xl pt-8 pb-4">¿Qué vacunas son obligatorias para viajar a ${destino}?</h2>
