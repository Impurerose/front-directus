          ...
          <div className="w-full flex gap-y-6 flex-col">
            <div className="flex items-start gap-x-6">
              <ShieldCheckIcon
                ...
                weight="duotone"
                size={40}
                className="text-[#006FE8] shrink-0"
              />
              <p className="text-[#70777C] text-base leading-6">
                Lorem ipsum dolor sit amet consectetur. Vitae magnis blandit
                neque eget sit ipsum. Ac semper nisl turpis tellus duis aliquet
                vitae. Volutpat libero nulla.
              </p>
            </div>
            <div className="flex items-start gap-x-6">
              <ShieldCheckIcon
